...
public class BasePage {
    ...
    public void clickToElement(WebDriver driver, String DynamicLocator, String pageName) {
    ...
    public void sendKeysToElement(WebDriver driver, String dynamicLocator, String textValue,
    ...
    public void selectItemInDefaultDropdown(WebDriver driver, String dynamicLocator, String textItem,
                                                            String... dynamicValues) {
    ...
    public void waitForElementVisible(WebDriver driver, String dynamicLocator,
                                      String... dynamicValues) {
        WebDriverWait explicitWait = new WebDriverWait(driver, longTimeout);
